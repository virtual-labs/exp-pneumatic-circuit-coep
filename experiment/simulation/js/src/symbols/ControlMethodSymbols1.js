...
function generalSym(canvas,x1,y1){
	...
	var generalSymPort = generalSym.createPort("hybrid", new draw2d.layout.locator.XYRelPortLocator(50,70));
		generalSymPort.setName("generalSymPortName");
		generalSymPort.setId("generalSymPortId");
...
var LabeldgeneralSymFigure = draw2d.SetFigure.extend({
	...
	init : function(attr)
    {
	  ...
	  createSet : function() {
			...
			this.canvas.paper.path("M 20 0 M 50 65 l -30 0 M 50 75 l -30 0 l 0 7 l 0 -24").attr({
				"stroke-width" : 1
			});
			
			this.canvas.paper.path("M 50 65 l 0 10").attr({
				"stroke-width" : 1
			});
...
function pushBtn(canvas,x1,y1){
	...
	var pushBtnPort = pushBtn.createPort("hybrid", new draw2d.layout.locator.XYRelPortLocator(50,70));
		pushBtnPort.setName("pushBtnPortName");
		pushBtnPort.setId("pushBtnPortId");
...
var LabeldpushBtnFigure = draw2d.SetFigure.extend({
	...
	init : function(attr)
    {
	  ...
	  createSet : function() {
			...
			this.canvas.paper.path("M 20 0 M 50 65 l -30 0 M 50 75 l -30 0 l 0 7 l 0 -24 q -15 12 0 25").attr({
				"stroke-width" : 1
			});
...
function leverSym(canvas,x1,y1){
	...
	var leverSymPort = leverSym.createPort("hybrid", new draw2d.layout.locator.XYRelPortLocator(50,70));
		leverSymPort.setName("leverSymPortName");
		leverSymPort.setId("leverSymPortId");
...
var LabeldleverSymFigure = draw2d.SetFigure.extend({
	...
	init : function(attr)
    {
	  ...
	  createSet : function() {
			...
			this.canvas.paper.path("M 20 0 M 50 75 l -30 0 M 50 65 l -27 0 l 3 -8 l -9 26").attr({
				"stroke-width" : 1
			});
...
function pedalSym(canvas,x1,y1){
	...
	var pedalSymPort = pedalSym.createPort("hybrid", new draw2d.layout.locator.XYRelPortLocator(50,70));
		pedalSymPort.setName("pedalSymPortName");
		pedalSymPort.setId("pedalSymPortId");
...
var LabeldpedalSymFigure = draw2d.SetFigure.extend({
	...
	init : function(attr)
    {
	  ...
	  createSet : function() {
			...
			this.canvas.paper.path("M 20 0 M 50 75 l -30 0 M 50 65 l -27 0 l 3 -8 l -7 0 l 7 0 l -9 26").attr({
				"stroke-width" : 1
			});
...
function plunger(canvas,x1,y1){
	...
	var plungerPort = plunger.createPort("hybrid", new draw2d.layout.locator.XYRelPortLocator(50,70));
		plungerPort.setName("plungerPortName");
		plungerPort.setId("plungerPortId");
...
var LabeldplungerFigure = draw2d.SetFigure.extend({
	...
	init : function(attr)
    {
	  ...
	  createSet : function() {
			...
			this.canvas.paper.path("M 20 0 M 50 65 l -30 0 q -5 5 0 10 l 30 0").attr({
				"stroke-width" : 1
			});
...
function roller(canvas,x1,y1){
	...
	var rollerPort = roller.createPort("hybrid", new draw2d.layout.locator.XYRelPortLocator(50,70));
		rollerPort.setName("rollerPortName");
		rollerPort.setId("rollerPortId");
...
var LabeldrollerFigure = draw2d.SetFigure.extend({
	...
	init : function(attr)
    {
	  ...
	  createSet : function() {
			...
			this.canvas.paper.path("M 20 0 M 50 65 l -30 0 M 50 75 l -30 0 ").attr({
				"stroke-width" : 1
			});
...
function rollerTrip(canvas,x1,y1){
	...
	var rollerTripPort = rollerTrip.createPort("hybrid", new draw2d.layout.locator.XYRelPortLocator(50,70));
		rollerTripPort.setName("rollerTripPortName");
		rollerTripPort.setId("rollerTripPortId");
...
function springSym(canvas,x1,y1){
	...
	var springSymPort1 = springSym.createPort("hybrid", new draw2d.layout.locator.XYRelPortLocator(10,70));
		springSymPort1.setName("springSymPort1Name");
		springSymPort1.setId("springSymPort1Id");
		
	var springSymPort2 = springSym.createPort("hybrid", new draw2d.layout.locator.XYRelPortLocator(50,70));
		springSymPort2.setName("springSymPort2Name");
		springSymPort2.setId("springSymPort2Id");	
...
var LabeldspringSymFigure = draw2d.SetFigure.extend({
	...
	init : function(attr)
    {
	  ...
	  createSet : function() {
			...
			this.canvas.paper.path("M 20 0 M 50 70 l -5 -15 l -10 30 l -10 -30 l -10 30 l -5 -15").attr({
				"stroke-width" : 1
			});
...
function electroMagnet(canvas,x1,y1){
	...
	var electroMagnetPort = electroMagnet.createPort("hybrid", new draw2d.layout.locator.XYRelPortLocator(50,70));
		electroMagnetPort.setName("electroMagnetPortName");
		electroMagnetPort.setId("electroMagnetPortId");
...
var LabeldelectroMagnetFigure = draw2d.SetFigure.extend({
	...
	init : function(attr)
    {
	  ...
	  createSet : function() {
			...
			this.canvas.paper.path("M 20 0 M 50 60 l -25 0 l 0 20 l 25 0 M 32 75 l 10 -10").attr({
				"stroke-width" : 1
			});
			
			this.canvas.paper.path("M 50 60 l 0 20").attr({
				"stroke-width" : 1
			});
...
function solenoidServoValve(canvas,x1,y1){
	...
	var solenoidServoValvePort = solenoidServoValve.createPort("hybrid", new draw2d.layout.locator.XYRelPortLocator(50,70));
		solenoidServoValvePort.setName("solenoidServoValvePortName");
		solenoidServoValvePort.setId("solenoidServoValvePortId");
...
var LabeldsolenoidServoValveFigure = draw2d.SetFigure.extend({
	...
	init : function(attr)
    {
	  ...
	  createSet : function() {
			...
			this.canvas.paper.path("M 20 0 M 50 60 l -45 0 l 0 20 l 20 0 l 0 -20 l 6 10 l -6 10 l 25 0 M 10 75 l 10 -10").attr({
				"stroke-width" : 1
			});
